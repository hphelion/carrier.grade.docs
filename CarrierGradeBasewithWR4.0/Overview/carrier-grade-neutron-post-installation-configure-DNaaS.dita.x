...
<title>HPE Helion <tm tmtype="reg">OpenStack</tm> Carrier Grade 2.0 Alpha: DNSaaS Configuration (Optional)</title>
<prolog>
<metadata>
...
<p>It is important to read through this page before starting your installation as it explains how to install and configure DNS as a service (DNSaaS) for HPE Helion <tm tmtype="reg">OpenStack</tm></p>
<p>
...
<ul>
<li>HPE Helion <tm tmtype="reg">OpenStack</tm> is successfully installed</li>
...
<p>d. Click <b>Sign up Now</b> below the description in the Configure dialog box.<!--A BR tag was used here in the original source.--> 
   The page navigates to the HPE Helion Product Catalog. Then, do the following:</p>
...
<p>i. Click <b>Submit</b>.<!--A BR tag was used here in the original source.--> The credentials are authenticated and the account is created. <!--A BR tag was used here in the original source.--> Once you register on the HPE Helion Product Catalog, you are required to configure your credentials.</p>
</li>
...
<ul>
<li>
  <xref href="../../publiccloud/apidocs/c1.1/dns-api.dita"  >HPE Helion Public Cloud DNS API Specifications</xref>
</li>
<li>
...
<p>
<b>Note</b>: Public Cloud API and HPE Helion Openstack API details are similar.</p>
<p>
