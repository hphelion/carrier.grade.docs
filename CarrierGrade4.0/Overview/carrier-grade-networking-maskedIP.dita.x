...
<title>HPE Helion <tm tmtype="reg">OpenStack</tm> Carrier Grade 2.0 Alpha: Tracking masked IP addresses when using network address translation (NAT)</title>
<prolog>
<metadata>
...
<ol>
<li>
<p>Log in to the HPE Helion <tm tmtype="reg">OpenStack</tm> Commercial dashboard as cloud admin.</p>
</li>
<li>
